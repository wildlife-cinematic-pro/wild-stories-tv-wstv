...
export const predatorData: Record<string, PredatorInfo> = {
  ...
  texture: "thick winter grey coat, frost on guard hairs, visible breath plumes, snow kicked from paws, sharp icy fur detail",
...
"Wolf Pack": {
  ...
  cameraGear: "Nikon Z9, 400mm wildlife lens, long-lens documentary tracking across snow",
  texture: "thick winter grey coats, frost on guard hairs, visible breath plumes, snow kicked from paws, sharp icy fur detail",
  driftRisk: "MEDIUM",
  defaultArc: "Pack hunting strategy",
},
  Jaguar: {
