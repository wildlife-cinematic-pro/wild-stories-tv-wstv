...
export const predatorData: Record<string, PredatorInfo> = {
  ...
  environment: "Yellowstone valley and northern Rocky Mountain forest in winter",
  lighting: "cold winter dawn light, pale blue snow shadows, drifting frost, visible breath vapor, soft backlight through pine trees",
  cameraGear: "Nikon Z9, 400mm wildlife lens, long-lens documentary tracking across snow",
  texture: "natural grey wolf coat, sunlit guard hairs, clean muzzle detail, natural paw contact with grass and uneven ground, clean realistic fur texture",
  defaultArc: "Pack hunting strategy",
  driftRisk: "MEDIUM",
},
"Wolf Pack": {
  prey: ["Elk", "Deer", "Bison Calf", "Moose Calf"],
  environment: "Yellowstone valley and northern Rocky Mountain forest in winter",
  lighting: "golden hour, warm backlight, long shadows, warm 3200K colour temperature",
  cameraGear: "Nikon Z9, 400mm wildlife lens, long-lens documentary tracking across snow",
  texture: "natural grey wolf coats, sunlit guard hairs, clean muzzle detail, natural paw contact with grass and uneven ground, clean realistic fur texture",
  driftRisk: "MEDIUM",
  defaultArc: "Pack hunting strategy",
},
  Jaguar: {
  ...
  "Polar Bear": {
    ...
    environment: "Alaskan river rapids and Rocky Mountain wilderness in late summer",
    lighting: "dramatic overcast mountain light, river mist in the air, silver water reflections, heavy cloud diffusion, natural cold contrast",
    cameraGear: "Canon EOS R3, 400mm wildlife lens, river-level wildlife documentary framing",
    texture: "massive shaggy brown coat with wet fur clumps, muscular shoulder hump, scarred muzzle detail, mud on claws, water spray on fur",
    defaultArc: "Territory dominance battle",
    driftRisk: "LOW",
  },
  Hyena: {
