...
export const predatorData: Record<string, PredatorInfo> = {
  Lion: {
    ...
    cameraGear:
      "Canon EOS R5, 200mm wildlife lens, natural telephoto perspective",
    texture:
      "ultra detailed fur, dust on coat, visible muscle tension, realistic dry grass interaction",
  ...
  Tiger: {
    ...
    lighting:
      "natural jungle light, soft volumetric rays through foliage, wet highlights, realistic atmospheric mist",
    cameraGear:
      "Sony A1, 200mm wildlife lens, natural cinematic compression",
    texture:
      "wet fur detail, visible whiskers, jungle moisture on coat, realistic muscle definition",
  ...
  "Siberian Tiger": {
    ...
    lighting:
      "dim winter taiga light, soft snowfall diffusion, cold blue shadows, stripe contrast against white snow",
    cameraGear:
      "Nikon Z9, 300mm wildlife lens, slow exposure snowfall atmosphere",
    texture:
      "thick winter orange-white coat, snow accumulation on fur, massive paw prints, visible exhale vapor",
    defaultArc: "Ambush attack",
    driftRisk: "HIGH",
  },
  Wolf: {
    ...
    texture:
      "natural grey wolf coat, layered guard hairs, lean muscle definition, sharp muzzle detail, realistic paw contact on dirt, grass, frost, and uneven ground",
    defaultArc: "Chase and takedown",
    driftRisk: "MEDIUM",
  },
  "Wolf Pack": {
    ...
    cameraGear:
      "Nikon Z9, 400mm wildlife lens, long-lens documentary tracking across meadow and forest edge",
    texture:
      "natural grey wolf coats, layered guard hairs, lean pack-built bodies, clean muzzle detail, realistic paw contact on dirt, grass, frost, and uneven ground",
    driftRisk: "MEDIUM",
  ...
  Jaguar: {
    ...
    lighting:
      "humid natural jungle light, reflected river glow, soft filtered sunlight, deep realistic contrast",
    cameraGear: "Canon EOS R3, 250mm wildlife lens, rich environmental depth",
    texture:
      "wet spotted coat, water droplets, sharp whiskers, powerful shoulders, realistic riverbank mud detail",
    defaultArc: "Ambush attack",
    driftRisk: "HIGH",
  },
  Leopard: {
    ...
    lighting:
      "natural sunset side light, realistic warm edge light, long shadows, dry atmospheric haze",
    cameraGear:
      "Sony A7R V, 200mm wildlife lens, natural cinematic perspective",
  ...
  Cheetah: {
    ...
    lighting:
      "warm side light across short grass, soft rim light on coat, long shadow readability, subtle dust haze in the air",
    cameraGear: "Sony A1, 300mm wildlife lens, tracking shot specialist framing",
    texture:
      "sleek spotted coat, deep chest expansion, tear mark facial detail, aerodynamic muscle definition",
    defaultArc: "Chase and takedown",
    driftRisk: "HIGH",
  },
  "Snow Leopard": {
    ...
    lighting:
      "crisp high altitude mountain light, cold blue shadows, sharp contrast on white snow",
    cameraGear:
      "Canon EOS R5, 400mm super-telephoto, extreme reach wildlife framing",
    texture:
      "thick spotted winter coat, snow crystals on fur, large padded paws, visible breath vapor",
    defaultArc: "Ambush attack",
    driftRisk: "HIGH",
  },
  Crocodile: {
    ...
    cameraGear:
      "Canon EOS R5, 135mm wildlife lens, low angle natural documentary framing",
    texture:
      "wet armored scales, muddy splash detail, sharp eye reflections, realistic rippling water",
    defaultArc: "Ambush attack",
    driftRisk: "LOW",
  },
  "Nile Crocodile": {
    ...
    cameraGear:
      "Canon EOS R3, 500mm wildlife lens, river bank ambush framing",
    texture:
      "ancient rough scales, yellow muddy water streaming off body, explosive splash detail",
    defaultArc: "Ambush attack",
    driftRisk: "LOW",
  },
  Bear: {
    ...
    lighting:
      "misty dawn light, cool natural shadows, subtle backlight, drifting fog",
    cameraGear:
      "Nikon Z8, 200mm telephoto lens, natural environmental framing",
    texture:
      "dense fur texture, visible breath, rugged body detail, realistic moisture in fur",
  ...
  "Polar Bear": {
    ...
    lighting:
      "polar day flat white light, cold blue ice shadows, warm amber horizon glow",
    cameraGear:
      "Nikon Z9, 400mm super-telephoto, extreme cold weather wildlife framing",
    texture:
      "thick layered white fur, wet muzzle, massive paws on ice, visible breath in extreme cold",
    defaultArc: "Ambush attack",
    driftRisk: "LOW",
  },
  "Grizzly Bear": {
    ...
    texture:
      "massive shaggy brown coat, muscular shoulder hump, scarred muzzle detail, dry earth on claws, wind-tossed fur",
    defaultArc: "Territory dominance battle",
    driftRisk: "LOW",
  },
  Hyena: {
  ...
  "African Wild Dog": {
    ...
    texture:
      "patchy painted coat detail, large round ears, lean athletic build, red dust on paws",
    defaultArc: "Pack hunting strategy",
    driftRisk: "MEDIUM",
  },
  Eagle: {
    ...
    lighting:
      "clean natural mountain light, crisp high-altitude contrast, realistic golden edge light",
  ...
  "Golden Eagle": {
    ...
    lighting:
      "stormy highland light, shafts of gold through dark clouds, fierce wind in grass and feathers",
    cameraGear:
      "Canon EOS R5, 600mm super-telephoto, sky-to-ground dive tracking",
    texture:
      "golden nape feathers, powerful talon detail, wing feather separation in dive",
    defaultArc: "Chase and takedown",
    driftRisk: "MEDIUM",
  },
  "Harpy Eagle": {
    ...
    lighting:
      "filtered equatorial light through thick canopy, dappled green glow, deep forest contrast",
    cameraGear: "Canon EOS R3, 400mm wildlife lens, canopy-level framing",
    texture:
      "dramatic grey and black crest feathers, massive talons, piercing yellow eyes",
    defaultArc: "Ambush attack",
    driftRisk: "MEDIUM",
  },
  "Bald Eagle": {
    ...
    texture:
      "bright white head feathers against dark brown body, sharp yellow talons, hooked golden beak, layered feather detail, wind through wings",
    defaultArc: "Chase and takedown",
    driftRisk: "MEDIUM",
  },
  Shark: {
    ...
    lighting:
      "natural underwater light rays, suspended particles, realistic ocean diffusion, deep blue atmosphere",
    cameraGear:
      "Canon EOS R5, 24mm wide-angle, natural underwater documentary framing",
    texture:
      "smooth grey skin with subtle texture, powerful tail movement, realistic underwater particle suspension",
    defaultArc: "Ambush attack",
    driftRisk: "LOW",
  },
  Orca: {
    ...
    lighting:
      "dramatic overcast Pacific light, white spray backlight, dark water surface reflections",
    cameraGear:
      "Nikon Z9, 300mm wildlife lens, surface and underwater split framing",
    texture:
      "bold black and white markings, powerful breach trajectory, realistic water spray and wake",
    defaultArc: "Pack hunting strategy",
    driftRisk: "LOW",
  },
  "Komodo Dragon": {
    ...
    lighting:
      "harsh equatorial midday sun, deep shadow contrast, heat shimmer, bleached earth tones",
    cameraGear:
      "Sony A1, 300mm wildlife lens, ground-level reptile documentary framing",
    texture:
      "armored scale texture, forked tongue detail, heavy clawed feet, prehistoric skin pattern",
    defaultArc: "Ambush attack",
    driftRisk: "LOW",
  },
  "Saltwater Crocodile": {
    ...
    lighting:
      "tropical dry season light, mirror water surface, crocodile eye reflection, deep shadow under mangroves",
    cameraGear:
      "Canon EOS R3, 400mm wildlife lens, water-level estuary framing",
    texture:
      "massive prehistoric scale armor, olive-grey mottled pattern, bone-crushing jaw detail",
    defaultArc: "Ambush attack",
    driftRisk: "LOW",
  },
  "Leopard Seal": {
    ...
    lighting:
      "polar flat white overcast light, ice reflection glow, steel-blue water reflections",
    cameraGear: "Nikon Z9, 500mm wildlife lens, ice-level framing",
    texture:
      "spotted grey pattern, massive jaw width, powerful neck, ice crystals on wet skin",
    defaultArc: "Ambush attack",
    driftRisk: "LOW",
  },
  "Black Mamba": {
    ...
    lighting:
      "midday African sun, dappled shadow under sparse acacia, high contrast on black scales",
    cameraGear:
      "Canon EOS R5, 200mm macro-telephoto, ground-level serpentine framing",
    texture:
      "iridescent dark olive-grey scales, coffin-shaped head detail, jet black mouth interior",
    defaultArc: "Ambush attack",
    driftRisk: "MEDIUM",
  },
  "African Lion Male": {
    ...
    lighting:
      "golden hour side light, rim light on dark mane, deep shadow under mane, amber dust in air",
    cameraGear:
      "Canon EOS R3, 300mm wildlife lens, eye-level ground framing",
    texture:
      "massive dark mane, scarred muzzle detail, heavy paw definition, golden coat contrast",
    defaultArc: "Territory dominance battle",
    driftRisk: "HIGH",
  },
  "Tasmanian Devil": {
    ...
    lighting:
      "overcast Tasmanian light, damp forest floor, diffuse soft shadows",
    cameraGear:
      "Sony A7R V, 200mm wildlife lens, ground-level documentary framing",
    texture:
      "coarse black fur with white chest marking, powerful jaw detail, pink ear flush when stressed",
  ...
  Chimpanzee: {
    ...
    lighting:
      "filtered equatorial canopy light, dappled floor shadows, humid green atmosphere",
    cameraGear:
      "Canon EOS R5, 300mm wildlife lens, forest floor and canopy framing",
    texture:
      "coarse dark hair, expressive facial skin detail, powerful forearm muscle definition",
    defaultArc: "Pack hunting strategy",
    driftRisk: "HIGH",
  },
  Wolverine: {
    ...
    lighting:
      "low subarctic sun, long blue shadows across snow, silver overcast boreal light",
    cameraGear: "Nikon Z9, 300mm wildlife lens, snow-level boreal framing",
    texture:
      "dense two-layer fur with frost, powerful low build, wide paw spread on snow",
    defaultArc: "Territory dominance battle",
    driftRisk: "MEDIUM",
  },
  Puma: {
    ...
    lighting:
      "mountain afternoon light, dappled forest edge, golden hour on open slope",
    cameraGear: "Sony A1, 300mm wildlife lens, mountain terrain framing",
    texture:
      "tawny smooth coat, deep chest, long powerful tail, mountain dust on paws",
    defaultArc: "Ambush attack",
    driftRisk: "HIGH",
  },
  "Mountain Lion": {
  ...
  Cougar: {
    ...
    texture:
      "solid tawny coat, muscular shoulders, pale underbelly, damp forest debris on paws, sleek powerful body detail",
    defaultArc: "Ambush attack",
    driftRisk: "HIGH",
  },
  Bobcat: {
    ...
    texture:
      "short spotted tawny coat, sharp ear tufts, compact muscular build, black-tipped tail, dust on paws and whiskers",
    defaultArc: "Ambush attack",
    driftRisk: "HIGH",
  },
  "Black Bear": {
    ...
    texture:
      "glossy black fur with moisture on coat, tan muzzle detail, broad shoulder mass, claws on wet moss and roots",
    defaultArc: "Territory dominance battle",
    driftRisk: "LOW",
  },
  Coyote: {
  ...
  Alligator: {
    ...
    texture:
      "dark armored scales with algae patches, yellow-green eyes above waterline, powerful jaw detail, rippling wake behind tail",
    defaultArc: "Ambush attack",
    driftRisk: "LOW",
  },
  Bison: {
    ...
    texture:
      "massive shaggy dark-brown front coat, lighter hindquarters, horn boss detail, dust on hooves, heavy muscle weight in shoulders",
  ...
  Moose: {
    ...
    texture:
      "massive dark-brown body, broad palmate antlers, dewlap detail, wet lower legs, thick autumn coat, visible breath in cold air",
    defaultArc: "Defender stands ground",
    driftRisk: "LOW",
  },
  "Bull Elk": {
    ...
    texture:
      "deep auburn coat, massive antler rack, heavy neck muscle detail, churned frost under hooves, breath clouds in cold air",
    defaultArc: "Defender stands ground",
    driftRisk: "MEDIUM",
  },
  "Musk Ox": {
    ...
    lighting:
      "flat arctic blizzard light, zero visibility atmosphere, snow driving horizontally, cold blue-white 4000K palette",
    cameraGear:
      "Nikon Z9, 400mm super-telephoto, extreme weather wildlife framing",
    texture:
      "prehistoric shaggy dark brown qiviut coat hanging to ground, curved boss horns, snow embedded in fur, massive lowered head",
    defaultArc: "Defender stands ground",
    driftRisk: "LOW",
  },
  "Cape Buffalo": {
    ...
    lighting:
      "warm African golden hour, backlit dust clouds, rim light on curved horns, long dramatic shadows",
    cameraGear:
      "Canon EOS R3, 500mm wildlife lens, waterhole ground-level framing",
    texture:
      "dark scarred hide with mud and dust, massive curved boss horn, battle-worn body, red clay on legs",
    defaultArc: "Defender stands ground",
    driftRisk: "LOW",
  },
  Dolphin: {
    ...
    lighting:
      "bright underwater sun rays, caustic patterns on skin, realistic surface reflections, suspended particles in blue-green water",
    cameraGear:
      "Canon EOS R5, underwater housing, 24mm wide-angle, split-shot surface and underwater framing",
    texture:
      "smooth grey skin with subtle scars, water droplets in a breach, sleek dorsal fin cutting surface, realistic bubbles and spray",
    defaultArc: "Pack hunting strategy",
    driftRisk: "LOW",
  },
  Raccoon: {
    ...
    lighting:
      "mixed porch light and moonlight, realistic low-light grain, wet highlights on fur, soft bokeh street lights in background",
    cameraGear:
      "Sony A7S III, 70-200mm telephoto zoom, handheld low-light documentary framing",
    texture:
      "grey fur with black facial mask, ringed tail detail, wet paw prints on concrete, whiskers catching light, subtle mud and water droplets",
    defaultArc: "Ambush attack",
    driftRisk: "MEDIUM",
  },
  Skunk: {
    ...
    lighting:
      "soft overcast dusk light, porch-light spill on grass, warm highlights on black fur, deep shadows under shrubs",
    cameraGear: "Canon EOS R5, 200mm wildlife lens, ground-level stalking perspective",
    texture:
      "glossy black fur with crisp white stripes, raised tail plume, dust on paws, fine scent-spray mist visible when threatened",
    defaultArc: "Defender stands ground",
    driftRisk: "MEDIUM",
  },
  Opossum: {
    ...
    lighting:
      "cold moonlight with flashlight bounce, hard specular eye-shine, damp leaf-litter reflections, deep shadow falloff",
    cameraGear:
      "Canon EOS R5, 100mm macro-telephoto, close nocturnal wildlife framing with shallow depth of field",
    texture:
      "coarse grey fur with white guard hairs, pink nose and ears, long whiskers, scaly prehensile tail detail, wet leaf debris on coat",
  ...
  "Red Fox": {
    ...
    lighting:
      "cold winter dawn light, soft pink horizon glow, crisp rim light on fur, drifting snow particles, long blue shadows on snow",
    cameraGear: "Nikon Z8, 300mm wildlife lens, fast shutter pounce tracking",
    texture:
      "rust-red winter coat with white chest, black legs, white-tipped tail, fine frost on whiskers, paw prints pressed into fresh snow",
    defaultArc: "Chase and takedown",
    driftRisk: "MEDIUM",
  },
  Beaver: {
    ...
    texture:
      "dark wet fur clumped in strands, flat paddle tail with scaly detail, orange incisors, water droplets beading on coat, mud on claws and whiskers",
    defaultArc: "Defender stands ground",
    driftRisk: "MEDIUM",
  },
  "River Otter": {
    ...
    lighting:
      "soft overcast light, silver water reflections, mist drifting above surface, natural splash highlights on wet fur",
    cameraGear:
      "Nikon Z9, 300mm wildlife lens, high shutter speed splash tracking",
    texture:
      "sleek waterproof brown fur, whiskers with water beads, webbed feet detail, smooth sliding motion on wet rocks, ripples and spray realism",
    defaultArc: "Chase and takedown",
    driftRisk: "MEDIUM",
  },
  Badger: {
    ...
    lighting:
      "harsh midday prairie sun, deep crisp shadows in burrow mounds, heat shimmer over grass, dust motes catching light",
    cameraGear:
      "Sony A1, 400mm super-telephoto, low-angle tracking across short grass",
    texture:
      "stocky low body, black-and-white facial stripe, coarse grizzled coat, powerful digging claws throwing soil, dust on nose and whiskers",
    defaultArc: "Territory dominance battle",
    driftRisk: "MEDIUM",
  },
  "Great Horned Owl": {
    ...
    lighting:
      "moonlit silhouette framing, faint blue ambient fill, subtle cloud-shadow movement, soft rim light on feather tufts",
    cameraGear:
      "Canon EOS R5, 600mm super-telephoto, silent flight dive tracking from treeline",
    texture:
      "intricate mottled brown feathers, prominent ear tufts, piercing yellow eyes, talons extended with feather separation, breath mist in cold air",
    defaultArc: "Ambush attack",
    driftRisk: "MEDIUM",
  },
  "White-tailed Deer": {
    ...
    texture:
      "reddish-brown coat with grey winter tones, bright white tail flag raised in alarm, alert ear detail, wet grass brushing legs, breath visible in cool air",
    defaultArc: "Escape from danger",
    driftRisk: "MEDIUM",
  },
  "Wild Boar": {
    ...
    texture:
      "coarse bristly dark hair, mud-caked hide, sharp tusk detail, foam on snout, churned-up wet soil and splashes",
    defaultArc: "Territory dominance battle",
    driftRisk: "MEDIUM",
  },
  "Brown Bear": {
...
export const weatherVariants: Record<Weather, string> = {
 "Golden Hour":
  ...
  Overcast:
    "soft overcast light, even diffuse illumination, no harsh shadows, true-to-life neutral colours",
  Dawn:
    "blue hour pre-dawn, cool 5500K ambient, low mist at ground level, first light on horizon",
  "Midday Heat":
    "harsh midday sun, short crisp shadows, heat shimmer rising from ground, high contrast",
  "Winter Blizzard":
    "heavy snowfall, cold blue-white light, breath steam visible, snow-capped mountains in background, icy ground, 4200K arctic colour temperature",
  "Frozen Dusk":
    "deep purple-orange frozen dusk, last light on snow, long blue shadows across white ground, breath mist catching fading sunlight",
};
...
export const emotionalTonePrompt: Record<
  EmotionalTone,
  { image: string; video: string; voiceover: string }
> = {
  "Raw Tension": {
    image:
  ...
  "Calm Dominance": {
    image:
      "quiet absolute dominance — predator utterly composed, zero urgency, radiating total control of its environment",
    video:
  ...
  "Desperate Survival": {
    image:
      "raw survival desperation — wide eyes, full muscle engagement, survival instinct overriding everything else",
    video:
...
export const animalVibePrompt: Record<
  AnimalVibe,
  { style: string; camera: string; texture: string }
> = {
  "BBC Earth Documentary": {
    style:
      "BBC Earth cinematic documentary realism — perfect natural lighting, zero artifice, every detail anatomically precise",
    camera:
      "professional wildlife documentary camera team — patient long-lens observation, animals completely unaware of camera",
    texture:
      "ultra-realistic fur/scale/feather detail — individual hairs visible, natural oils on coat, environmental debris on body",
  },
  "National Geographic Wild": {
    style:
      "National Geographic Wild — dramatic composition, peak moment capture, story-driven framing",
    camera:
  ...
  "Raw Nature Unfiltered": {
    style:
      "raw unfiltered nature — no cinematic polish, this is nature as it actually is, imperfect and real",
    camera:
      "handheld wildlife observation — slight natural shake, reactive framing, documentary truth over aesthetics",
    texture:
      "gritty authentic texture — mud, blood, saliva, environmental debris — nature is not clean",
  },
  "David Attenborough Style": {
    style:
      "David Attenborough documentary aesthetic — warm educational gravitas, patient observation, reverence for nature",
    camera:
      "classic wildlife documentary lens — wide establishing, slow zoom, patient observational framing",
    texture:
      "rich natural texture — warm colour grading, soft diffuse detail, nature presented with dignity and awe",
  },
  "Slow Motion Nature": {
    style:
      "phantom camera slow motion wildlife — every micro-movement visible, physics of nature revealed at 1000fps aesthetic",
    camera:
      "high-speed wildlife cinematography — motion blur on fast elements, crystalline clarity on impact moments",
    texture:
      "hyper-detailed slow-motion texture — water droplets mid-air, fur rippling in slow waves, muscle fibre definition",
  },
};
...
export function calculateViralScore(
  ...
  const hookScore = Math.max(
    ...
    Math.min(
      ...
      (hook.length <= 68 ? 6 : 3) +
        ...
        (/mistake|late|wrong|seconds|territory|surrounded|react|danger|locked|trouble|boundary/.test(
          hookLower
        )
          ? 6
          : 1) -
        (/watch the last|nobody expected|once in a lifetime|scientists say|you won't believe/.test(
          hookLower
        )
          ? 4
          : 0)
  ...
  const usaScore = Math.min(
    ...
    (usaArcs.includes(arc) ? 8 : 4) +
      (usaAnimals.includes(predator) && usaAnimals.includes(prey)
        ? 8
        : usaAnimals.includes(predator) || usaAnimals.includes(prey)
        ? 6
        : 3) +
  ...
  scores.push({
    label: "USA Audience Fit",
    score: usaScore,
    tip:
      usaScore >= 16
        ? "USA-optimized ✓"
        : "Use Wolf Pack/Bison/Alligator/Mountain Lion + strong clash or ambush arcs",
  });

  const origScore = Math.min(20, (pkg.veo3Shots ? 7 : 0) + (pkg.qualitySummary ? 6 : 0) + (pkg.sceneDesc ? 7 : 3));
  scores.push({
    label: "Originality Signal",
    score: origScore,
    tip: origScore >= 16 ? "High originality ✓" : "Enable Quality Controls + add Scene Description",
  });

  const highEmotionArcs: Arc[] = [
    "Giant vs giant clash",
    "Defender stands ground",
    "Escape from danger",
    "Ambush attack",
  ...
  const emotScore = Math.min(15, (highEmotionArcs.includes(arc) ? 8 : 5) + ((pkg.caption2026?.length ?? 0) > 200 ? 7 : 4));
  scores.push({
    ...
    tip:
      emotScore >= 12
        ...
        : "Use clash, ambush, pack-pressure, or escape arcs + story-based caption",
  });
...
export function buildFiveShotCinematic(
  ...
  return {
    ...
    shot5: `[RUNWAY ${runwayModel}] SHOT 5 — RESOLVED TENSION (36–48s):\n${rN}\n${predator} remains clearly readable in ${env}, ${w} after the action beat. Keep the ending simple, dominant, and visually clean for mobile. ${
      emotionalTone === "Calm Dominance" ? "Absolute stillness. Total ownership." : "Heavy breath. Eyes forward. Pressure still lingers."
    } ${vibe.camera}. End on a strong readable final frame with loop-ready clarity. Motion strength: 30.`,
    totalDuration: "38–48 seconds",
    watchTimeNote:
      "Balanced story mode: keep the opening instantly readable, keep the middle escalating, and keep the full runtime tight enough for stronger completion on short-form platforms.",
    captionTip:
      "Keep burned-in captions very short and readable. The first caption should help the opening frame read instantly: LOOK / DANGER / IMPACT / ESCAPE / WHO WON?",
  };
}
...
export function buildFiveShotViral(
  ...
  return {
    ...
    totalDuration: "38–48 seconds",
    watchTimeNote:
      "This 38–48s version keeps the story readable while protecting short-form retention and first-frame impact.",
    captionTip:
      "Use short burned-in caption beats that read instantly: LOOK / PRESSURE / IMPACT / TURN / COMMENT. Keep the first caption readable in the opening second.",
  };
}
...
export function buildWatchTimeReport(
  ...
  return {
    ...
    estimatedMonthlyEarnings:
      "Variable — depends on audience, eligibility, format mix, and actual dashboard RPM.",
    usaCPMNote:
      "Use revenue estimates only as planning ranges. Meta payout varies by format, region, originality, advertiser demand, and beta access.",
    tipsToIncrease: [
      ...
      slots: [
        {
          ...
          why: "Strong weekday morning engagement window in multiple 2025–2026 studies.",
          priority: "🔥",
        },
        {
          zone: "CST (Chicago)",
          time: "7:00 AM – 9:00 AM",
          why: "Matches commuter + early-work scroll behavior.",
          priority: "⭐",
        },
        {
          zone: "PST (Los Angeles)",
          time: "5:00 AM – 7:00 AM",
          why: "Useful for reaching East + Central time zones early.",
          priority: "✅",
        },
      ],
    },
      ...
      slots: [
        {
          ...
          why: "Midday window often performs well for Facebook posts and reels.",
          priority: "🔥",
        },
        {
          zone: "CST (Chicago)",
          time: "11:00 AM – 2:00 PM",
          why: "Lunch + break-time viewing window.",
          priority: "⭐",
        },
        {
          zone: "PST (Los Angeles)",
          time: "9:00 AM – 12:00 PM",
          why: "Keeps the same midday pattern across zones.",
          priority: "✅",
        },
      ],
    },
      ...
      slots: [
        {
          ...
          why: "Useful starting point for weekend experiments.",
          priority: "🔥",
        },
        {
          zone: "CST (Chicago)",
          time: "9:00 AM – 12:00 PM",
          why: "Captures relaxed weekend browsing.",
          priority: "⭐",
        },
        {
          zone: "PST (Los Angeles)",
          time: "8:00 AM – 11:00 AM",
          why: "Lets one upload hit all major US zones reasonably well.",
          priority: "✅",
        },
      ],
    },
...
export function generateMonthlyCalendar(
  ...
  const rotations = [
    {
      predator: primaryPredator || "Mountain Lion",
      prey: primaryPrey || "White-tailed Deer",
  ...
  const hookTemplates = [
    ...
    (predator: string, prey: string) =>
      `${predator} was already too close when the ${prey.toLowerCase()} reacted. ⚠️`,
    ...
    (_predator: string, prey: string) =>
      `The ${prey.toLowerCase()} hesitated once. That was enough. ⚡`,
    ...
    (_predator: string, prey: string) =>
      `The ${prey.toLowerCase()} saw the threat late. Very late. ⚠️`,
    ...
    (_predator: string, prey: string) => `${prey.toLowerCase()} was moving, but never free. 👀`,
    () => `The whole mood changes before full action starts. 🎬`,
    (predator: string, prey: string) =>
      `${predator} boxed the ${prey.toLowerCase()} in before panic fully hit. 🧠`,
  ];
  ...
  return Array.from({ length: daysInMonth }, (_, i) => {
    ...
    return {
      day,
      dateLabel: new Date(year, month, day).toLocaleDateString(undefined, {
        month: "short",
        day: "numeric",
      }),
      weekday: new Date(year, month, day).toLocaleDateString(undefined, {
        weekday: "short",
      }),
      reel1: {
        predator: r1.predator,
        prey: r1.prey,
        arc: r1.arc,
        hook: rH[(day - 1) % rH.length](r1.predator, r1.prey),
        duration: rD[(day - 1) % rD.length],
      },
      reel2: {
        predator: r2.predator,
        prey: r2.prey,
        arc: r2.arc,
        hook: rH[day % rH.length](r2.predator, r2.prey),
        duration: rD[day % rD.length],
      },
      theme: rT[Math.floor((day - 1) / 4) % rT.length],
      cmpNote:
        totalVideos >= 30
          ? `🔥 CMP: ${totalVideos} videos — strong consistency signal • first-frame tension priority`
          : totalVideos >= 5
          ? `✅ CMP: ${totalVideos} videos posted • keep openings fast and readable`
          : `⏳ CMP: ${totalVideos}/5 videos minimum • prioritize immediate readable tension`,
    };
  });
}
...
function getUSAMonthSeason(monthIndex: number) {
  if ([11, 0, 1].includes(monthIndex)) {
    return {
      season: "Winter",
      themes: [
        "❄️ Snow Survival Week",
        "🦬 Yellowstone Giants Week",
        "🐺 Pack Pressure Week",
        "🧊 Frozen Ambush Week",
        "🦅 Harsh Elements Week",
        "🔥 Shock Ending Week",
      ],
      environment: "snow, cold breath, low-sun tension",
    };
  }
  if ([2, 3, 4].includes(monthIndex)) {
    return {
      ...
      environment: "fresh brush, woodland edge, spring light",
    };
  }
  if ([5, 6, 7].includes(monthIndex)) {
    return {
      ...
      themes: [
        "☀️ Heatwave Week",
        "🏜️ Dry Ground Week",
        "🐊 Everglades Ambush Week",
        "🦬 Dust Clash Week",
        "🦅 Open Sky Week",
        "🔥 Shock Ending Week",
      ],
      environment: "dust, heat shimmer, dry scrubland",
    };
  }
  return {
    season: "Fall",
    themes: [
      "🍂 Rut Season Week",
      "🦌 Elk Pressure Week",
      "🐺 Migration Pressure Week",
      "🪨 Rocky Ambush Week",
      "🦅 Golden Light Week",
      "🔥 Shock Ending Week",
    ],
    environment: "golden brush, migration tension, cold dusk",
  };
}
...
export function generateUSAViral30DayCalendar(
  ...
  const hookTemplates = [
    (_predator: string, prey: string) => `${prey} froze for one second. ⚠️`,
    (predator: string, prey: string) =>
      `${predator} was already too close when the ${prey.toLowerCase()} reacted. 👀`,
    (predator: string, prey: string) =>
      `${predator} vs ${prey} — the pressure starts immediately. 🔥`,
    () => `No slow setup. The threat is instant. 🎬`,
    (predator: string) => `This is why ${predator.toLowerCase()}s feel dangerous up close. ⚡`,
    (_predator: string, prey: string) =>
      `The ${prey.toLowerCase()} had almost no escape lane. 😳`,
  ...
  return Array.from({ length: 30 }, (_, i) => {
    ...
    return {
      ...
      reel2: {
        ...
        prey: r2.prey,
        arc: r2.arc,
        hook: rH[(day + 1) % rH.length](r2.predator, r2.prey),
        duration: rD[day % rD.length],
      },
...
export function getOriginalityChecklist(): OriginalityItem[] {
  return [
    {
      check: "Original content only",
      tip: "Create or meaningfully transform the content yourself. Minor edits to someone else's clip can be deprioritized or demonetized.",
      critical: true,
      source: "Meta original content guidelines",
    },
    {
      check: "Avoid low-value reuploads",
      tip: "Borders, speed changes, stitched clips, or simple reaction overlays are not enough on their own.",
      critical: true,
      source: "Meta original content guidelines",
    },
    {
      check: "Use clear AI transparency",
      tip: "When publishing fully synthetic or heavily edited photoreal content, add a clear disclosure or use available AI labels.",
      critical: true,
      source: "Meta AI labeling guidance",
    },
    {
      check: "Burned-in captions added",
      tip: "Use short burned-in captions that help the first 1–3 seconds read instantly on mute, especially during the opening tension beat.",
      critical: true,
      source: "Cross-platform video best practice",
    },
    {
      check: "Strong first-frame hook",
      tip: "Make the first shot instantly readable with visible predator pressure, clear subject separation, and no slow empty setup.",
      critical: true,
      source: "Creative best practice",
    },
    {
      check: "Consistent posting + testing",
      tip: "Test 1–2 Facebook reels per day only if opening-frame quality stays high; reduce volume if the first seconds become weak or repetitive.",
      critical: false,
      source: "Buffer 2026 frequency guidance",
    },
    {
      check: "Check Professional Dashboard",
      tip: "Facebook Content Monetization beta is invite-based. Keep checking your Professional Dashboard for access and policy status.",
      critical: true,
      source: "Meta Content Monetization beta",
    },
    {
      check: "Feature your best welcome reel",
      tip: "Use the Page Featured section to pin the reel with the clearest first-frame tension and strongest U.S.-readable wildlife setup.",
      critical: false,
