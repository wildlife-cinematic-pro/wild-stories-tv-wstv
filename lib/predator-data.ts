...
export const predatorData: Record<string, PredatorInfo> = {
  ...
  Wolf: {
    prey: ["Elk", "Deer", "Goat", "Rabbit"],
    environment: "snowy forest",
    lighting: "cold dawn light, realistic ambient blue tones, soft backlight, drifting snow particles",
    cameraGear: "Nikon Z9, 200mm wildlife lens, natural documentary framing",
    texture: "thick winter fur, visible breath vapor, snow on fur, crisp realistic coat detail",
  ...
  Cheetah: {
    ...
    lighting: "harsh midday sun, strong directional light, short crisp shadows, heat shimmer rising from ground",
  ...
  "Grizzly Bear": {
    prey: ["Salmon", "Elk Calf", "Deer", "Ground Squirrel"],
    environment: "Alaskan river canyon with rushing rapids",
    lighting: "dramatic overcast Pacific Northwest light, mist rising from river, diffuse silver-grey atmosphere",
    cameraGear: "Canon EOS R3, 400mm wildlife lens, river-level documentary framing",
    texture: "massive shaggy brown coat with silver tips, hump muscle definition, scarred muzzle, powerful digging claws",
    defaultArc: "Territory dominance battle",
    driftRisk: "LOW",
  },
  Hyena: {
  ...
  "Bald Eagle": {
    prey: ["Salmon", "Rabbit", "Duck", "Small Mammal"],
    environment: "Alaskan coastline with glacial river mouth",
    lighting: "dramatic Pacific Northwest overcast light, silver water surface reflections, clean cold atmosphere",
    cameraGear: "Canon EOS R5, 500mm super-telephoto, riverside low-angle framing",
    texture: "stark white head and tail feathers against dark brown body, bright yellow talons, golden beak",
    defaultArc: "Chase and takedown",
    driftRisk: "MEDIUM",
  },
  Shark: {
  ...
  "Mountain Lion": {
    prey: ["Mule Deer", "Bighorn Sheep", "Elk Calf", "Wild Boar"],
    environment: "Rocky Mountain conifer forest and rocky ridgeline",
    lighting: "mountain golden hour, long shadow on ridge, pine forest dapple, warm amber light on tawny coat",
    cameraGear: "Canon EOS R5, 400mm super-telephoto, ridge-level mountain framing",
    texture: "tawny smooth coat, powerful rear haunches, long balancing tail, pine needle debris on paws",
    defaultArc: "Ambush attack",
    driftRisk: "HIGH",
  },
  Cougar: {
    prey: ["Deer", "Elk Calf", "Wild Boar", "Bighorn Sheep"],
    environment: "Pacific Northwest dense forest",
    lighting: "overcast Pacific light, dense canopy filter, moss and fern floor glow, cool blue-green atmosphere",
    cameraGear: "Nikon Z8, 300mm wildlife lens, forest floor documentary framing",
    texture: "solid tawny coat, muscular haunches, dense forest floor debris, pale underbelly",
    defaultArc: "Ambush attack",
    driftRisk: "HIGH",
  },
  Bobcat: {
    prey: ["Rabbit", "Squirrel", "Wild Turkey", "Mule Deer Fawn"],
    environment: "Southwestern US desert scrub at twilight",
    lighting: "deep desert twilight, warm terracotta rock tones, last sky glow on horizon, cold blue shadows under brush",
    cameraGear: "Sony A1, 300mm wildlife lens, desert ground-level dusk framing",
    texture: "short tawny spotted coat, distinctive ear tufts, stubby black-tipped tail, compact powerful build",
    defaultArc: "Ambush attack",
    driftRisk: "HIGH",
  },
  "Black Bear": {
    prey: ["Salmon", "Deer Fawn", "Rabbit", "Ground Squirrel"],
    environment: "Great Smoky Mountains forest with morning fog",
    lighting: "Appalachian morning fog, soft diffuse light through dense oak canopy, green filtered atmosphere",
    cameraGear: "Nikon Z8, 300mm wildlife lens, forest documentary framing",
    texture: "glossy jet-black fur, tan muzzle, powerful shoulder hump, claws on mossy forest floor",
    defaultArc: "Territory dominance battle",
    driftRisk: "LOW",
  },
  Coyote: {
    prey: ["Jackrabbit", "Rabbit", "Wild Turkey", "Mule Deer Fawn"],
    environment: "open sagebrush prairie at dawn",
    lighting: "cold dawn light, soft side light, pale blue morning shadows across dry grass",
    cameraGear: "Sony A1, 300mm wildlife lens, low documentary ground framing",
    texture: "lean grey-brown coat, alert ears, narrow muzzle, dusty paws, wiry tail fur",
    defaultArc: "Chase and takedown",
    driftRisk: "MEDIUM",
  },
  Alligator: {
    prey: ["Wild Boar", "Deer", "Raccoon", "Large Fish", "Turtle"],
    environment: "Florida Everglades cypress swamp with Spanish moss",
    lighting: "humid subtropical dusk light, golden reflections on dark tannin water, firefly-like light patches through moss",
    cameraGear: "Canon EOS R5, 200mm wildlife lens, water-surface level swamp framing",
    texture: "armored dark green-black scales with algae patches, powerful jaw with exposed teeth, yellow-green eyes above waterline, tail creating V-wake",
    defaultArc: "Ambush attack",
    driftRisk: "LOW",
  },
  Bison: {
    prey: ["Grizzly Bear", "Wolf Pack", "Mountain Lion", "Coyote Pack"],
    environment: "open Yellowstone grassland with geothermal steam",
    lighting: "dramatic golden hour light, backlit dust clouds, geothermal haze, rim light on massive horns",
    cameraGear: "Nikon Z9, 400mm super-telephoto, Yellowstone wide prairie framing",
    texture: "massive shaggy dark brown front half, lighter hindquarters, curved boss horn detail, red clay dust on hooves",
    defaultArc: "Defender stands ground",
    driftRisk: "LOW",
  },
  Moose: {
    prey: ["Wolf Pack", "Grizzly Bear", "Brown Bear", "Cougar"],
    environment: "boreal lake edge and willow wetlands in autumn",
    lighting: "northern autumn golden hour, reflected lake surface, breath mist in cold air, long shadows on wet ground",
    cameraGear: "Nikon Z9, 500mm wildlife lens, lake-level boreal framing",
    texture: "massive dark brown body, wide palmate antler rack, long pendulous nose, dewlap under jaw, thick winter coat",
    defaultArc: "Defender stands ground",
    driftRisk: "LOW",
  },
  "Bull Elk": {
    prey: ["Mountain Lion", "Wolf Pack", "Brown Bear", "Cougar"],
    environment: "open Rocky Mountain meadow in autumn with snow-dusted peaks",
    lighting: "golden autumn light, warm amber tones on antlers, breath mist in cold mountain air, long shadows across frost-covered grass",
    cameraGear: "Sony A1, 300mm wildlife lens, wide mountain meadow framing with peak backdrop",
    texture: "deep auburn coat, massive 6-point antler rack, powerful neck muscles, hooves churning frost-covered earth",
    defaultArc: "Defender stands ground",
    driftRisk: "MEDIUM",
  },
  "Musk Ox": {
...
export function suggestArc(predator: string, prey: string, fallback: string): string {
  ...
  if (p === "Orca" || p === "African Wild Dog") return "Pack hunting strategy";
