...
export default function ImagePage() {
  ...
  return (
    <main className="ui-theme-scope min-h-screen w-full bg-[radial-gradient(circle_at_top_left,rgba(20,184,166,0.16),transparent_32%),radial-gradient(circle_at_top_right,rgba(59,130,246,0.12),transparent_34%),#020617] text-[color:var(--text)]">
      <header className="z-40 border-b border-white/[0.07] bg-gray-950/90 backdrop-blur-xl lg:sticky lg:top-0">
        <div className="mx-auto flex w-full max-w-[var(--main-max-width)] flex-wrap items-center justify-between gap-2 px-4 py-2.5 sm:px-6 sm:py-3 lg:px-8">
      ...
      <div className="mx-auto w-full max-w-[var(--main-max-width)] px-4 py-5 pb-[calc(env(safe-area-inset-bottom)+1.5rem)] sm:px-6 sm:py-6 lg:px-8">
        <section className="mb-4 overflow-hidden rounded-[30px] border border-white/[0.09] bg-gradient-to-br from-gray-950/95 via-slate-950/95 to-cyan-950/50 p-3.5 sm:p-5 shadow-[var(--surface-shadow)]">
